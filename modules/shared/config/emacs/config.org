...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Jacob Molnia"
    user-mail-address "jrmolnia@wpi.edu")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/jake/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/jake/bin" "/profile/bin" "/Users/jake/.npm-packages/bin" "/Users/jake/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
